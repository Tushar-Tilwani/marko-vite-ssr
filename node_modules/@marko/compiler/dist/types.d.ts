...
export interface MarkoDeclaration extends BaseNode {
  type: "MarkoDeclaration";
  value: string;
}

export interface MarkoCDATA extends BaseNode {
  type: "MarkoCDATA";
  value: string;
}

export interface MarkoComment extends BaseNode {
  type: "MarkoComment";
  value: string;
}

export interface MarkoText extends BaseNode {
  type: "MarkoText";
  value: string;
}

export interface MarkoPlaceholder extends BaseNode {
  type: "MarkoPlaceholder";
  value: Expression;
  escape: boolean;
}

export interface MarkoScriptlet extends BaseNode {
  type: "MarkoScriptlet";
  body: Array<Statement>;
  static: boolean;
...
export interface MarkoAttribute extends BaseNode {
  type: "MarkoAttribute";
  name: string;
  value: Expression;
...
export interface MarkoSpreadAttribute extends BaseNode {
...
export interface MarkoTag extends BaseNode {
  type: "MarkoTag";
  name: Expression;
  attributes: Array<MarkoAttribute | MarkoSpreadAttribute>;
  body: MarkoTagBody;
  arguments: Array<Expression | SpreadElement> | null;
  var: LVal | null;
...
export function isMarko(node: object | null | undefined, opts?: object | null): node is Marko;
export function assertMarko(node: object | null | undefined, opts?: object | null): void;
export function isMarkoAttribute(node: object | null | undefined, opts?: object | null): node is MarkoAttribute;
export function assertMarkoAttribute(node: object | null | undefined, opts?: object | null): void;
export function isMarkoCDATA(node: object | null | undefined, opts?: object | null): node is MarkoCDATA;
export function assertMarkoCDATA(node: object | null | undefined, opts?: object | null): void;
export function isMarkoClass(node: object | null | undefined, opts?: object | null): node is MarkoClass;
export function assertMarkoClass(node: object | null | undefined, opts?: object | null): void;
export function isMarkoComment(node: object | null | undefined, opts?: object | null): node is MarkoComment;
export function assertMarkoComment(node: object | null | undefined, opts?: object | null): void;
export function isMarkoDeclaration(node: object | null | undefined, opts?: object | null): node is MarkoDeclaration;
...
export function assertMarkoScriptlet(node: object | null | undefined, opts?: object | null): void;
export function isMarkoSpreadAttribute(node: object | null | undefined, opts?: object | null): node is MarkoSpreadAttribute;
export function assertMarkoSpreadAttribute(node: object | null | undefined, opts?: object | null): void;
export function isMarkoTag(node: object | null | undefined, opts?: object | null): node is MarkoTag;
export function assertMarkoTag(node: object | null | undefined, opts?: object | null): void;
export function isMarkoTagBody(node: object | null | undefined, opts?: object | null): node is MarkoTagBody;
export function assertMarkoTagBody(node: object | null | undefined, opts?: object | null): void;
export function isMarkoText(node: object | null | undefined, opts?: object | null): node is MarkoText;
export function assertMarkoText(node: object | null | undefined, opts?: object | null): void;
...
export function isScope(node: object | null | undefined, opts?: object | null): node is Scope;
export function assertScope(node: object | null | undefined, opts?: object | null): void;
